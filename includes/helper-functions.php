...
function cortex_get_option($option_name, $default = null)
{
...
function cortex_update_option($option_name, $option_value)
{
    $settings = get_option('cortex_settings');
    ...
    update_option('cortex_settings', $settings);
}

function cortex_update_options($setting_data)
{
    $settings = get_option('cortex_settings');
...
function cortex_get_sysinfo()
{
    ...
    // Theme info
    $plugin = get_plugin_data(CORTEX_PLUGIN_FILE);
